      ...
      <div className="grid gap-10 md:grid-cols-2 md:gap-16">
        <div>
          ...
          <ul className="mt-7 space-y-3 text-ink-muted">
            <li>Анализ и документирование требований и процессов</li>
            <li>Сопровождение проектов от концепции до реализации</li>
            <li>Связь между бизнесом, дизайном, разработкой и тестированием</li>
          </ul>
        </div>
